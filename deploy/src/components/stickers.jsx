...
import { AiFillThunderbolt, AiOutlineBgColors } from 'react-icons/ai';
...
<div className="Top-container text-center py-1" style={{ backgroundColor: "yellow", height: "60px" }}>
                         <h1 style={{ color: "black", fontSize: "3rem", fontWeight: "bold" ,border:"5px"}}>  <i> -- </i> </h1> 
      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} ${
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          <button 
            ...
            style={{ color: " white ", fontWeight: "bold",  borderRadius: "300px", width: "300px", height: "100px" }}
          ...
          <button 
            onClick={() => setActiveTab('data')} style={{ color: " white ",  backgroundColor: "black ",fontWeight: "bold", borderRadius: "300px", width: "300px", height: "100px" }}
            className={`w-full flex items-center p-3 rounded-lg transition-colors ${
              activeTab === 'data' ? 
                (darkMode ? 'bg-gray-700' : 'bg-indigo-700') : 
                (darkMode ? 'hover:bg-gray-700' : 'hover:bg-indigo-600')
          ...
          <button 
            onClick={() => setActiveTab('users')} style={{ color: " white ", fontWeight: "bold",borderRadius: "300px", width: "300px", height: "100px" }}
            className={`w-full flex items-center p-3 rounded-lg transition-colors ${
              activeTab === 'users' ? 
                (darkMode ? 'bg-gray-700' : 'bg-indigo-700') : 
                (darkMode ? 'hover:bg-gray-700' : 'hover:bg-indigo-600')
          ...
          <button 
            onClick={() => setActiveTab('security')}style={{ color: " white ", fontWeight: "bold",  borderRadius: "300px", width: "300px", height: "100px" }}
            className={`w-full flex items-center p-3 rounded-lg transition-colors ${
              activeTab === 'security' ? 
                (darkMode ? 'bg-gray-700' : 'bg-indigo-700') : 
                (darkMode ? 'hover:bg-gray-700' : 'hover:bg-indigo-600')
...
<FiSearch size={200} style={{ color: " red ", fontWeight: "bold", borderRadius: "300px", width: "100px", height: "40px" }} />
...
<AiOutlineBgColors size={200} style={{ color: " red ", fontWeight: "bold", borderRadius: "300px", width: "100px", height: "40px" }} />
...
<BsImageAlt size={200} style={{ color: " red ", fontWeight: "bold", borderRadius: "300px", width: "100px", height: "40px" }} />
...
<FiLifeBuoy size={200} style={{ color: " red ", fontWeight: "bold", borderRadius: "300px", width: "100px", height: "40px" }} />
...
<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "50px" }} ></button>

<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "70px" }} ></button>

<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "100px" }} ></button>
<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "120px" }} ></button>
<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "140px" }} ></button>
<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "160px" }} ></button>
<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button>
<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button>
<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button>
<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button>
<button size={200} style={{ color: " red ",background:" black",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button><button size={200} style={{ color: " red ",background:" white",  fontWeight: "bold", borderRadius: "300px", width: "20px", height: "180px" }} ></button>
...
<div className="w-full max-w-lg mx-auto">
      ...
      >
          ...
          <SwiperSlide >
          <p><i>-------------------------</i></p>
          <h6> <BsActivity size={30} style={{ color: " black ", fontWeight: "bold", borderRadius: "300px", width: "100px", height: "40px" }}/> temp *  !</h6>

          <p><i>-------------------------</i></p>
          <h6> <BsActivity size={30} style={{ color: " black ", fontWeight: "bold", borderRadius: "300px", width: "100px", height: "40px" }}/> Fuel </h6>
          </SwiperSlide>
...
<div className="w-full max-w-lg mx-auto">
    ...
    <p>---------------------------------------------------------------------------------------------</p>
  <h4> <FiAlertTriangle size={30} style={{ color: " red ", fontWeight: "bold", borderRadius: "300px", width: "100px", height: "40px" }}/> Coution Mohan's Warning ! ! !
    ...
    <ul>
      ...
      <BsArrowUpRight size={30} style={{ color: " lightgreen ", fontWeight: "bold", borderRadius: "300px", width: "50px", height: "40px" }}/>
          on </button>
      <button > 
      <BsIndent size={30} style={{ color: " red ", fontWeight: "bold", borderRadius: "300px", width: "50px", height: "40px" }}/>
         off </button>

      <li><h6> <FiAlertTriangle size={30} style={{ color: " black ", fontWeight: "bold", borderRadius: "300px", width: "100px", height: "40px" }}/>
...
{/* 
<button
style={{ color: " black ", fontWeight: "bold", backgroundColor: "white ", borderRadius: "300px", width: "300px", height: "90px" }}
